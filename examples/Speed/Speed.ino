...
// Same as Blocking with slower moving speed
...
void loop()
{
    servo.writeBlocking(0, 5);      // goes to 0 degrees and wait to get there
    servo.writeBlocking(180, 5);    // goes to 180 degrees and wait to get there
}
